...
class EfficientUNet(nn.Module):
    def __init__(self, out_channels=2, retrain_backbone=False):
        ...
        self.backbone: timm.models.efficientnet.EfficientNet = timm.create_model("tf_efficientnetv2_b3.in1k", pretrained=True, num_classes=0)
        ...
        new_conv = nn.Conv2d(1, 40, kernel_size=(3, 3), stride=(2, 2), padding=1, bias=False)
        ...
        self.stage1 = torch.nn.Sequential(
            torch.nn.LazyConvTranspose2d(136, 1, 2),    torch.nn.LazyBatchNorm2d(), torch.nn.ReLU()
        )
        self.stage2 = torch.nn.Sequential(
            torch.nn.LazyConv2d(136, 3, 1, 'same'),     torch.nn.LazyBatchNorm2d(), torch.nn.ReLU(),
            torch.nn.LazyConvTranspose2d(56, 2, 2),     torch.nn.LazyBatchNorm2d(), torch.nn.ReLU()
        )
        self.stage3 = torch.nn.Sequential(
            torch.nn.LazyConv2d(56, 3, 1, 'same'),      torch.nn.LazyBatchNorm2d(), torch.nn.ReLU(),
        ...
        self.eval()(torch.zeros(1, 1, 240, 240))
